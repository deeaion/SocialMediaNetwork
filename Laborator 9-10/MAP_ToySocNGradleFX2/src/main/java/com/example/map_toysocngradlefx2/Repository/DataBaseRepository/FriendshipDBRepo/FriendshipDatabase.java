...
public class FriendshipDatabase extends AbstractDataBaseRepository<Tuple<Long,Long>, Friendship> {
    ...
    private Friendship getFriendshipFromStatement(ResultSet resultSet) throws SQLException
    {
        ...
        return new Friendship(user1, user2, friendsfrom.toLocalDateTime(),FriendshipStatus.valueOf(status));
        }
    @Override
    ...
    public Optional<Friendship> save(Friendship entity) {
        String insertSQL="INSERT INTO friendship(id_user1,id_user2,friendsfrom,status) values(?,?,?,?)";
    ...
    public Optional<Friendship> update(Friendship entity) {
        ...
        String updateStatement = "UPDATE friendship set friendsfrom=?,status=?" +
                " where (id_user1=? and id_user2=?)" +
                "or (id_user2=? and id_user1=?)";
        try {
